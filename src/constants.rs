...
pub(crate) static WORD_IDXS: once_cell::sync::Lazy<std::collections::HashMap<&'static str, u8>> =
...
pub(crate) static MINIMAL_IDXS: once_cell::sync::Lazy<std::collections::HashMap<&'static str, u8>> =
    once_cell::sync::Lazy::new(|| {
        [
            ("ae", 0),
            ("ad", 1),
